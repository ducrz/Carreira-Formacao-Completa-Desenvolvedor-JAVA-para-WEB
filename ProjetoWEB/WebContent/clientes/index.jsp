        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <div class="col-md-12  btn-group btn-group-lg btn-group-vertical">
              <a href="http://localhost:8080/ProjetoWEB/Controlador?idformulario=1&tipoformulario=11" class="btn btn-default">Consultar Todos os Clientes</a>
              <a href="consulta.jsp" class="btn btn-default">Consultar um Cliente Especí­fico</a>
